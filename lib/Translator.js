 ...
 * @type {!FilterList}
 */
Translator.stringFilter = new FilterList("objectFilter", _.isString);
...
Translator.prototype.get = function (key, parameter, language) {
  ...
  if (namespace != null) try {
    ...
    result = Translator.objectFilter.filter(result);
    result = Translator.stringFilter.filter(result);
    return result;
  } catch (e) {
